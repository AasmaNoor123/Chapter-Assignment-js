...
//1. write a program to take a number in a variable do the required arthemetic to display the following result in your browser.
...
document.write(sub1 + " " + 100 + " " + obtMarks1 + "<br>");
document.write(sub2 + " " + 100 + " " + obtMarks2 + "<br>");
document.write(sub3 + " " + 100 + " " + obtMarks3 + "<br>");
document.write("Total Marks: " + (totalMarks ) + " Total Obtained Marks: " + totalObtainedMarks + "<br>");
...
//}
//else{
     //document.write('Please!! Enter a right name of the city');
 }
...
/*7.Write a program to take input the marks obtained in three 
...
/*9. Write a program to check whether the given number is divisible by 3. Show the message to the user if the number is divisible by 3.
*/
